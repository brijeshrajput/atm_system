...
<body style="background-image:url(img/atm5.jpg)">
    <link href="style.css" rel="stylesheet" type="text/css" />
    <div class="header">
        <div class="inner-header">
            <div class="logo">
                <p>
                    <center>
                        MIET Bank ATM</center><br><br><br> <br><br><br>
                </p>
            </div>
        </div>
    </div>
    <div class="blurbox">
        <div class="row">
            <br><Br><BR>
            <h7> <b>
                    <div class="col-xs-2">Remaining Balance: </div>
                    <div class="col-xs-10">
                        ...
                        <div class="col-xs-10">
                            <center>
                                <form method="post" action="savings1.php">
                                    <br><br><br><input type="text" placeholder="Enter the amount to Withdraw"
                                        class="form-control input-lg" name="cash"><br><br>
