...
<body style="background-image:url(img/atm2.jpg); background-size: cover;">
    <div class="header">
    ...
    <div class="blurbox">
        ...
        <div class="row">
            <h9> <b>
                    <div class="col-xs-2">Transaction id: </div>
            </h9>
            <h7>
                <div class="col-xs-10">
        ...
        <div class="row">
            <h9><b>
                    <div class="col-xs-2">Branch Location: </div>
            </h9>
            <h7>
                <div class="col-xs-10">
